        ...
        <div class="col-12">
            <div class="card">
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($taglines as $tagline)
                                <tr>
                                    ...
                                    <td>{{ $tagline->name }}</td>
                                    <td><span class="badge rounded-pill bg-label-{{ $tagline->status ? 'primary':'danger' }}">{{ $tagline->status ? 'Active':'Deactive' }}</span></td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item delete-confirm" data-method="DELETE"
                                                    href="{{ route('admin.taglines.destroy', $tagline->id) }}">
                ...
                <div class="row mx-2 mt-2">
                    <div class="col-sm-12">
                        {{ $taglines->links('vendor.pagination.bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="create-term-modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <form action="{{ route('admin.taglines.index') }}" method="post" class="custom-reload-form">
                    @csrf

                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel2">Create new tagline</h5>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <form action="" method="post" class="custom-reload-form tagline-edit-form">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Tagline update</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" id="name" class="form-control name" name="name"
                                    placeholder="Enter tagline name" required>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="status" class="form-label">Status</label>
