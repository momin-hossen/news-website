<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Route::is('admin.tags.index', 'admin.categories.index', 'admin.blogs.create', 'admin.blogs.index', 'admin.blogs.edit') ? 'active open' :'' }}">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ Route::is('admin.tags.index') ? 'active' :'' }}">
                ...
                <li class="menu-item {{ Route::is('admin.blogs.create') ? 'active' :'' }}">
                    <a href="{{ route('admin.blogs.create') }}" class="menu-link">
                        <div>@lang('Create Blog')</div>
                    </a>
                </li>
                <li class="menu-item {{ Route::is('admin.blogs.index', 'admin.blogs.edit') ? 'active' :'' }}">
                    <a href="{{ route('admin.blogs.index') }}" class="menu-link">
                        <div>@lang('Manage Blog')</div>
                    </a>
                </li>
            </ul>
        </li>

        <li class="menu-item {{ Route::is('admin.pages.index', 'admin.pages.create', 'admin.pages.edit') ? 'active open' :'' }}"">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class='menu-icon bx bxs-file-html'></i>
                <div>{{ __('Custom Page') }}</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ Route::is('admin.pages.create') ? 'active' :'' }}"">
                    <a href="{{ route('admin.pages.create') }}" class="menu-link">
                        <div>{{ __('Create Page') }}</div>
                    </a>
                </li>
                <li class="menu-item {{ Route::is('admin.pages.index') ? 'active' :'' }}"">
                    <a href="{{ route('admin.pages.index') }}" class="menu-link">
                        <div>{{ __('Manage Pages') }}</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item {{ Request::is('admin/settings/*') ? 'active open' :'' }}"">
            ...
            <ul class="menu-sub">
                <li class="menu-item {{ Route::is('admin.settings.seo.index', 'admin.settings.seo.edit') ? 'active' :'' }}"">
                    <a href="{{ route('admin.settings.seo.index') }}" class="menu-link">
                        <div>{{ __('Seo Settings') }}</div>
                    </a>
                </li>
                <li class="menu-item {{ Route::is('admin.settings.menu.index') ? 'active' :'' }}"">
                    <a href="{{ route('admin.settings.menu.index') }}" class="menu-link">
                        <div>{{ __('Menu Settings') }}</div>
                    </a>
                </li>
                <li class="menu-item {{ Route::is('admin.settings.languages.index', 'admin.settings.languages.edit') ? 'active' :'' }}"">
        ...
        <li class="menu-item {{ Route::is('admin.sub_news_categories.index') ? 'active' :'' }}">
            <a href="{{ route('admin.sub_news_categories.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-news"></i>
                <div>{{ __('Sub News Category') }}</div>
            </a>
        </li>

        <li class="menu-item {{ Route::is('admin.news.index') ? 'active' :'' }}">
        ...
        <li class="menu-item {{ Route::is('admin.reporters.index') ? 'active' :'' }}">
            <a href="{{ route('admin.reporters.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bxs-report"></i>
                <div>{{ __('News Reporter') }}</div>
            </a>
        </li>
